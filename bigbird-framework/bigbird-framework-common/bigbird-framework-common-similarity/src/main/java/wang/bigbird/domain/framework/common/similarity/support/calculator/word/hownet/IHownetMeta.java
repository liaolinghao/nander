 ...
 */
package wang.bigbird.domain.framework.common.similarity.support.calculator.word.hownet;
...
public interface IHownetMeta {
    ...
    /**
     * Θ计算后面概念的义原与参照概念所有义原的最大相似度，并乘以两个概念主义原相似度的积
     * （主义原通过该方式起约束作用），
    ...
    /**
     * Ω计算前面概念的义原与参照概念所有义原的最大相似度，并乘以两个概念主义原相似度的积
     * （主义原通过该方式起约束作用），
