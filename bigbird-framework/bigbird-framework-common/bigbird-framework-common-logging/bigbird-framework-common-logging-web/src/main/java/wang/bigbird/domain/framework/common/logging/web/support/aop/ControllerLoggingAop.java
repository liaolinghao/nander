 ...
 */
package wang.bigbird.domain.framework.common.logging.web.support.aop;
...
import wang.bigbird.domain.framework.common.logging.web.config.property.ControllerLoggingProperties;
...
@ConditionalOnProperty(
        prefix = "bigbird.common.logging.controller",
        name = "enable",
        havingValue = "true"
)
public class ControllerLoggingAop extends BaseLoggingAop implements Ordered {

    @Autowired
    private ControllerLoggingProperties controllerLoggingProperties;
    ...
    public ExcludeWrapper getExclude() {
        List<String> excludes = controllerLoggingProperties.getExcludes();
        return ExcludeHandlerUtils.buildExcludeWrapper(excludes);
    }

    @Override
    public Integer getSerializeLength() {
        return controllerLoggingProperties.getSerializeLength();
    }
