 ...
 */
package wang.bigbird.domain.framework.server.web.quartz.config.configuration;
 ...
 */
@Slf4j
@ComponentScan("wang.bigbird.domain.framework.server.web.quartz")
@Configuration
public class WebQuartzConfiguration {

    @PostConstruct
    public void init() {
        log.info("init quartz web framework.");
    }
